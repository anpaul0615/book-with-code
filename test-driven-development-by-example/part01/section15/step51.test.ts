 ...
 * Step 51
 * 
 * - 테스트 대상코드 수정 (Expression 에 plus() 시그니처 정의)
 * - 테스트 통과 확인
 */
namespace step51 {
  ...
  interface Expression {
    ...
    plus(addend: Expression): Expression;  // 더하기 함수 시그니처 정의
  }
  ...
  class Sum implements Expression {
    ...
    plus(addend: Expression): Expression {  // 더하기 함수 임시구현
      return null;
    }
  }
   ...
   * Test Suites
   */
  describe.skip('Differnct Currency Calculation (Step 51)', ()=>{
